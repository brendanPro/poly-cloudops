...
locals {
  ...
  # Suffix for resources based on workspace/environment
  # Returns "" for default/production, and "-staging" for staging
  env_suffix = terraform.workspace == "staging" ? "-staging" : ""
...
resource "google_iam_workload_identity_pool" "github_pool" {
  workload_identity_pool_id = "github-actions-pool${local.env_suffix}"
